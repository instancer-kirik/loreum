  ...
  const [projects, setProjects] = useState<Project[]>([
    {
      id: '1',
      name: 'New Horizons',
      description: 'A space opera setting with multiple civilizations spanning the galaxy',
    ...
    },
    {
      ...
      description: 'A low-fantasy medieval world with mysterious frontiers',
  ...
  return (
    <div className="h-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* New Project Card */}
        <div className="bg-gray-800 bg-opacity-60 rounded-lg border-2 border-dashed border-gray-700 p-6 flex flex-col items-center justify-center cursor-pointer hover:bg-opacity-80 transition-colors h-72">
