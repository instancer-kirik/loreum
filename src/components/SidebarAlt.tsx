      ...
      >
          ...
          <div className="flex items-center justify-center py-4">
            <div className="relative">
              ...
              <div className="relative glass-panel p-3 rounded-lg flex items-center justify-center">
                <FaGlobe
                  className="h-8 w-8 text-flame-blue"
        ...
        {breadcrumbs.length > 0 && (
          <div className="mx-4 mb-4">
            ...
            <h3 className="text-xs font-serif text-glyph-accent tracking-wider mb-2">
              NAVIGATION PATH
            </h3>
        ...
        <div className="mx-4 mb-6">
          ...
          <h2 className="text-center font-serif text-lg text-glyph-bright tracking-wider">
            ...
            {navigationContext.level === "civilization" &&
            ...
            {menuItems.map((item) => (
              <li key={item.id}>
                ...
                >
                  ...
                  <span
                    className={`mr-3 ${currentPage === item.id ? "text-flame-blue" : ""}`}
                  >
                    {item.icon}
                  </span>
        ...
        <div className="p-4 border-t border-cosmic-light border-opacity-20">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm font-serif text-glyph-bright">
                  Architech
                </p>
                <p className="text-xs text-glyph-accent">
                  ...
                  {![
                    ...
                    "world",
                    "civilization",
                  ].includes(navigationContext.level) && "Creator"}
                </p>
              </div>
            </div>
